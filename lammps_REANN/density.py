...
class GetDensity(torch.nn.Module):
    ...
    def forward(self,cart,ef,atom_index,local_species,neigh_list):
        ...
        density,worbital=self.obtain_orb_coeff(0,nlocal,orbital,ef_orbital,atom_index[0],neigh_list,orb_coeff,hyper)
        for ioc_loop, (_, m) in enumerate(self.ocmod.items()):
            ...
            density,worbital = self.obtain_orb_coeff(ioc_loop+1,nlocal,orbital,ef_orbital,atom_index[0],neigh_list,orb_coeff,hyper)
