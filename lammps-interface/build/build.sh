...
#cmake -D BUILD_MPI=ON -D BUILD_OMP=ON -D LAMMPS_MACHINE=mpi -D CMAKE_BUILD_TYPE=RELEASE ../cmake
cmake -D BUILD_MPI=ON -D BUILD_OMP=ON -D LAMMPS_MACHINE=mpi -D CMAKE_BUILD_TYPE=RELEASE -D PKG_REPLICA=on -D PKG_SPIN=on -D PKG_MISC=on ../cmake
